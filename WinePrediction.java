	...
	public static void main(String[] args) {
		// --------------------------------------- Start Spark Context --------------------------------------- //
			...
			// --------------------------------------- Load and Parse the Test Data --------------------------------------- //
			    ...
			    //String test_path = "s3://dsqualitywine/ValidationDataset.csv";//
			...
			// --------------------------------------- Build Model --------------------------------------- //
				...
				/**LogisticRegressionModel model = LogisticRegressionModel.load(sc.sc(),"s3://dsqualitywine/LogisticRegressionModel/");**/
